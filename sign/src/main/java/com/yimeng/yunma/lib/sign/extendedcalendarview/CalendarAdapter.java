package com.yimeng.yunma.lib.sign.extendedcalendarview;
...
public class CalendarAdapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(position >= 0 && position < 7){
			v = vi.inflate(R.layout.sign_day_of_week, null);
			TextView day = (TextView)v.findViewById(R.id.textView1);
			if(position == 0){
				day.setText(R.string.sign_sunday);
			}else if(position == 1){
				day.setText(R.string.sign_monday);
			}else if(position == 2){
				day.setText(R.string.sign_tuesday);
			}else if(position == 3){
				day.setText(R.string.sign_wednesday);
			}else if(position == 4){
				day.setText(R.string.sign_thursday);
			}else if(position == 5){
				day.setText(R.string.sign_friday);
			}else if(position == 6){
				day.setText(R.string.sign_saturday);
			}
		}else{
	        v = vi.inflate(R.layout.sign_day_view, null);

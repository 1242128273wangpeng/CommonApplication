...
public class PGActivityUtils {
    ...
    private static PGActivityUtils instance;
    private long clickTime = 0; //记录第一次点击的时间

    private PGActivityUtils() {
     ...
     * @return
     */
    public static PGActivityUtils getInstance() {
        if (null == instance) {
            instance = new PGActivityUtils();
        }
        return instance;

package com.yimeng.common.recycler.adapter;
...
import com.yimeng.common.recycler.helper.ItemTouchHelperAdapter;
import com.yimeng.common.recycler.helper.OnStartDragListener;
import com.yimeng.common.recycler.helper.SimpleItemTouchHelperCallback;
import com.yimeng.common.recycler.listener.OnItemMoveListener;
import com.yimeng.common.recycler.listener.OnRecyclerViewItemClickListener;
import com.yimeng.common.recycler.listener.OnRecyclerViewItemLongClickListener;
import com.yimeng.common.recycler.listener.OnRemoveDataListener;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case FOOTER_VIEW:
                break;
            default:
                convert((BaseViewHolder) holder, mData.get(holder.getLayoutPosition() - getHeaderViewsCount()), position);
